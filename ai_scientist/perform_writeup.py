...
# TJ from ai_scientist.generate_ideas import search_for_papers
# TJ from ai_scientist.llm import get_response_from_llm, extract_json_between_markers
from generate_ideas import search_for_papers, search_for_papers_from_arXive
...
if __name__ == "__main__":
    ...
    #papers = search_for_papers_from_arXive(query)
